...
/**
 *
 * @see XenForo_Importer_vBulletin
 */
class ThemeHouse_VbToFriends_Extend_XenForo_Importer_vBulletin extends XFCP_ThemeHouse_VbToFriends_Extend_XenForo_Importer_vBulletin
{
